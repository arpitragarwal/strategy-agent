...
export const QUANT_DATASETS: DatasetMeta[] = [
  ...
  {
    id: "crm/product_usage",
    relativePath: "crm/product_usage.csv",
    domain: "crm",
    description:
  ...
  },
  {
    ...
    domain: "cx",
    description:
      "Quarterly satisfaction aligned to product_usage rows: account_id, fiscal_quarter, csat_score (1–5 Likert), nps_score (−100…100). CSAT/NPS correlate weakly with usage_tier in the generator.",
  },
];
...
export const QUANT_JOIN_RELATIONSHIPS = [
  ...
  "**crm/product_usage** → **crm/renewals** on [[\"account_id\",\"account_id\"]] (add renewal outcome, ARR); filter or group on fiscal_quarter vs renewal_quarter as needed.",
  "**cx/customer_satisfaction** → **crm/product_usage** on [[\"account_id\",\"account_id\"],[\"fiscal_quarter\",\"fiscal_quarter\"]] for usage_tier with csat_score / nps_score.",
] as const;
